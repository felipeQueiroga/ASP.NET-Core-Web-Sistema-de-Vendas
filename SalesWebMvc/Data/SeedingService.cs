...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s7 = new Seller(7, "Luis Felipe", "luisfelipequeiroga@hotmail.com", new DateTime(1994, 03, 30), 3000.0, d2);
            ...
            SalesRecord r31 = new SalesRecord(31, new DateTime(2018, 10, 12), 5000.0, SaleStatus.Billed, s7);
